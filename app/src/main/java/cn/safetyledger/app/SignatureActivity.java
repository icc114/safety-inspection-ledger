...
public final class SignatureActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){super.onCreate(b);iid=getIntent().getStringExtra("inspection_id");role=getIntent().getStringExtra("role");
